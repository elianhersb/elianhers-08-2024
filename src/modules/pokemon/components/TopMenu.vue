...
import { navegations } from '../Navegations/Index';
</script>
  ...
  <nav class="fixed top-0 left-0 z-20 w-full border-b border-gray-200 bg-white py-2.5 px-6 sm:px-4">
    <div class="container mx-auto flex max-w-6xl flex-wrap items-center justify-between">
      <router-link to="/" class="flex items-center">
        ...
        <span class="ml-2 self-center whitespace-nowrap text-xl font-semibold">Pokemon Team</span>
      </router-link>

      <div class="mt-2 sm:mt-0 sm:flex md:order-1">
        <button
      ...
      <div
        class="hidden w-full items-center justify-between md:order-3 md:flex md:w-auto"
        id="navbar-sticky"
      >
        <ul
